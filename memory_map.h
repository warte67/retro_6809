...
JOYS_BEGIN       = 0x1C7C, // Start of the Game Controller Register space
JOYS_1_BTN       = 0x1C7C, //   (Word) button bits: room for up to 16 buttons  (realtime)
JOYS_1_DBND      = 0x1C7E, //   (Byte) PAD 1 analog deadband; default is 5   (read/write)
JOYS_1_LTX       = 0x1C7F, //   (char) PAD 1 LThumb-X position (-128 _ +127)   (realtime)
JOYS_1_LTY       = 0x1C80, //   (char) PAD 1 LThumb-Y position (-128 _ +127)   (realtime)
JOYS_1_RTX       = 0x1C81, //   (char) PAD 1 RThumb-X position (-128 _ +127)   (realtime)
JOYS_1_RTY       = 0x1C82, //   (char) PAD 1 RThumb-Y position (-128 _ +127)   (realtime)
JOYS_1_Z1        = 0x1C83, //   (char) PAD 1 left analog trigger (0 - 127)     (realtime)
JOYS_1_Z2        = 0x1C84, //   (char) PAD 1 right analog trigger (0 - 127)    (realtime)

JOYS_2_BTN       = 0x1C85, //   (Word) button bits: room for up to 16 buttons  (realtime)
JOYS_2_DBND      = 0x1C87, //   (Byte) PAD 2 analog deadband; default is 5   (read/write)
JOYS_2_LTX       = 0x1C88, //   (char) PAD 2 LThumb-X position (-128 _ +127)   (realtime)
JOYS_2_LTY       = 0x1C89, //   (char) PAD 2 LThumb-Y position (-128 _ +127)   (realtime)
JOYS_2_RTX       = 0x1C8A, //   (char) PAD 2 RThumb-X position (-128 _ +127)   (realtime)
JOYS_2_RTY       = 0x1C8B, //   (char) PAD 2 RThumb-Y position (-128 _ +127)   (realtime)
JOYS_2_Z1        = 0x1C8C, //   (char) PAD 2 left analog trigger (0 - 127)     (realtime)
JOYS_2_Z2        = 0x1C8D, //   (char) PAD 2 right analog trigger (0 - 127)    (realtime)
JOYS_END         = 0x1C8E, // End of the Game Controller Register space

FIO_BEGIN        = 0x1C8E, // Start of the FileIO register space
FIO_ERR_FLAGS    = 0x1C8E, // (Byte) File IO error flags
...
FIO_COMMAND      = 0x1C8F, // (Byte) OnWrite, execute a file command (FC_<cmd>)
        // Begin FIO_COMMANDS
...
FIO_STREAM       = 0x1C90, // (Byte) current file stream index (0-15)
FIO_MODE         = 0x1C91, // (Byte) Flags describing the I/O mode for the file
...
FIO_SEEKPOS      = 0x1C92, // (DWord) file seek position
FIO_IOBYTE       = 0x1C96, // (Byte) input / output character
FIO_IOWORD       = 0x1C97, // (Byte) input / output character
FIO_PATH_LEN     = 0x1C98, // (Byte) length of the filepath
FIO_PATH_POS     = 0x1C99, // (Byte) character position within the filepath
FIO_PATH_DATA    = 0x1C9A, // (Byte) data at the character position of the path
FIO_DIR_DATA     = 0x1C9B, // (Byte) a series of null-terminated filenames
...
FIO_END          = 0x1C9C, // End of the FileIO register space

        // Math Co-Processor Hardware Registers:
MATH_BEGIN       = 0x1C9C, //  start of math co-processor  hardware registers
MATH_ACA_POS     = 0x1C9C, //  (Byte) character position within the ACA float string
MATH_ACA_DATA    = 0x1C9D, //  (Byte) ACA float string character port
MATH_ACA_RAW     = 0x1C9E, //  (4-Bytes) ACA raw float data
MATH_ACA_INT     = 0x1CA2, //  (4-Bytes) ACA integer data
MATH_ACB_POS     = 0x1CA6, //  (Byte) character position within the ACB float string
MATH_ACB_DATA    = 0x1CA7, //  (Byte) ACB float string character port
MATH_ACB_RAW     = 0x1CA8, //  (4-Bytes) ACB raw float data
MATH_ACB_INT     = 0x1CAC, //  (4-Bytes) ACB integer data
MATH_ACR_POS     = 0x1CB0, //  (Byte) character position within the ACR float string
MATH_ACR_DATA    = 0x1CB1, //  (Byte) ACR float string character port
MATH_ACR_RAW     = 0x1CB2, //  (4-Bytes) ACR raw float data
MATH_ACR_INT     = 0x1CB6, //  (4-Bytes) ACR integer data
MATH_OPERATION   = 0x1CBA, //  (Byte) Operation 'command' to be issued
...
MATH_END         = 0x1CBB, // end of math co-processor registers
