...
MOP_NAN             equ   $0009    ;        (bool)ACR = std::isnan(ACA);
MOP_NORMAL          equ   $000A    ;        (bool)ACR = std::isnormal(ACA);
...
MOP_FMAX            equ   $0012    ;        ACR = std::std::fmax(ACA, ACB);
...
MOP_NETAFTER        equ   $0036    ;        ACR = std::nextafter(ACA, ACB);
