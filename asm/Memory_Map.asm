...
MMU_ERR_MAPPING       equ    $0004    ;    $04 = Memory Mapping Error
MMU_ERR_UNMAPPING     equ    $0005    ;    $05 = Error Unmapping Memory
MMU_ERR_INVALID       equ    $0006    ;    $06 = Invalid Command
MMU_ERR_ARGUMENT      equ    $0007    ;    $07 = Invalid Argument
MMU_ERR_HANDLE        equ    $0008    ;    $08 = Invalid Handle
MMU_ERR_NODE          equ    $0009    ;    $09 = Invalid Node
MMU_ERR_PAGE          equ    $000A    ;    $0A = Invalid Page
MMU_ERR_BANK          equ    $000B    ;    $0B = Invalid Bank
MMU_ERR_ADDRESS       equ    $000C    ;    $0C = Invalid Address
MMU_ERR_OFFSET        equ    $000D    ;    $0D = Invalid Offset
MMU_ERR_LENGTH        equ    $000E    ;    $0E = Invalid Length
MMU_ERR_INDEX         equ    $000F    ;    $0F = Invalid Index
MMU_ERR_UNKNOWN       equ    $0010    ;    $10 = Unknown Error
MMU_ERR_SIZE          equ    $0011    ;    $11 = Total Number of MMU Errors
                                      ; 
