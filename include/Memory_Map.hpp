...
enum MEMMAP
{
    ...
    SYS_DEVICE            = 0x0000,   // START: System and Debug Hardware Registers:
    SYS_BEGIN             = 0x0000,   // Start of System Registers
    SYS_STATE             = 0x0000,   // (Byte) System State Register
                                      // SYS_STATE: ABCD.SSSS                          
                                      ...
                                      // 
    SYS_SPEED             = 0x0001,   // (Word) Average CPU Clock Speed (Read Only)
                          = 0x0002,   // 
    SYS_CLOCK_DIV         = 0x0003,   // (Byte) 60 hz Clock Divider Register (Read Only)
                                      // - bit 7: 0.546875 hz
                                      // - bit 6: 1.09375 hz
                                      // - bit 5: 2.1875 hz
                                      // - bit 4: 4.375 hz
                                      ...
                                      // - bit 0: 70.0 hz
                                      // 
    SYS_UPDATE_COUNT      = 0x0004,   // (Byte) Update Count (Read Only)
                          = 0x0005,   // 
                          = 0x0006,   // 
                          = 0x0007,   // 
    SYS_DBG_BRK_ADDR      = 0x0008,   // (Word) Address of current debug breakpoint
                          = 0x0009,   // 
    SYS_DBG_FLAGS         = 0x000A,   // (Byte) Debug Specific Hardware Flags:
                                      // - bit 7: Debug Enable
                                      ...
                                      // 
    SYS_END               = 0x000A,   // End of System Registers
    SYS_TOP               = 0x000B,   // Top of System Registers
                                      // 

    GPU_DEVICE            = 0x000B,   // START: GPU Device Hardware Registers
    GPU_OPTIONS           = 0x000B,   // (Byte) Bitflag Enables
                                      ...
                                      //               1: Enabled
                                      // 
    GPU_MODE              = 0x000C,   // (Byte) Bitflag Enables
                                      ...
                                      // 
    GPU_VIDEO_MAX         = 0x000D,   // (Word) Video Buffer Maximum (Read Only)
                                      ...
                                      //        standard video mode.
                          = 0x000E,   // 
    GPU_HRES              = 0x000F,   // (Word) Horizontal Resolution (Read Only)
                                      //   Note: This will reflect the number of
                                      //        pixel columns for bitmap modes.
                          = 0x0010,   // 
    GPU_VRES              = 0x0011,   // (Word) Vertical Resolution (Read Only)
                                      //   Note: This will reflect the number of
                                      //        pixel rows for bitmap modes.
                          = 0x0012,   // 
    GPU_TCOLS             = 0x0013,   // (Byte) Text Horizontal Columns (Read Only)
                                      //   Note: This will reflect the number of
                                      //        glyph columns for text modes.
                                      // 
                          = 0x0014,   // 
    GPU_TROWS             = 0x0015,   // (Byte) Text Vertical Rows (Read Only)
                                      //   Note: This will reflect the number of
                                      //        glyph rows for text modes.
                                      // 
                          = 0x0016,   // 
    GPU_END               = 0x0016,   // End of GPU Register Space
    GPU_TOP               = 0x0017,   // Top of GPU Register Space
